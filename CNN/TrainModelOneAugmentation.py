...
train_transform = DualTransform(disturbance_class=disturbances[disturbance_mode], coeffs=disturbance_coeffs[disturbance_mode])
...
file_name = f'{disturbance_mode}_gtsrb_{mode.lower()}_model.pth'
...
metrics_file = f"{disturbance_mode}_{mode.lower()}_metrics.json"
